...
<body>
	<div class="page-lock">
		<div class="page-logo">
			...
			<img src="/images/backadminlogo.png" alt="logo" />
			</a>
		</div>
		<div class="page-body">
			<img class="page-lock-img" src="assets/img/profile/profile.jpg" alt="">
			<div class="page-lock-info">
				<h1><?php echo htmlspecialchars($this->userInfo["uname"])?></h1>
				<span class="email"><?php echo htmlspecialchars($this->userInfo["email"])?></span>
				...
				<form class="form-inline" action="index.html">
					...
					<!-- /input-group -->
					<div class="relogin">
						<a href="login.html">Not <?php echo htmlspecialchars($this->userInfo["uname"])?> ?</a>
					</div>
				</form>
			</div>
		</div>
